/*! p5qbots.js v1.0.1 December 09, 2020 */
...
var Ports = function (boardType) {
  console.log('Type is ' , boardType);
  if(boardType) {
    this.boardType = boardType;
  }
  console.log('ports object');
};
