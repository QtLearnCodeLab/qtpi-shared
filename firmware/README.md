...
| :--- | :--- | :---: | :--- | :---: | :--- | :---: | :--- |
| **`qtpi-veda-esp32`** | `firmata-dual` | **`1.0.11`** | `esptool` | `0x0000` | `qtpi-esp32-firmata-v1.0.11.bin` | 1,337,488 | `cd6681d2f27412b9fb58fb571c998a24d389a08a907c78fc9210e0fc1532b68b` |
| **`qtpi-veda-esp32`** | `micropython` | **`1.1.3`** | `esptool` | `0x0000` | `qtpi-esp32-micropython-v1.1.3.bin` | 15,794,176 | `968d77f390c1a97709dde524f297c39e55302d69db23f97a8ca9d5e7a3df1313` |
